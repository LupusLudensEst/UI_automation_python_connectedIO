...
wait.until(EC.presence_of_element_located(LOGIN_PASSWORD)).send_keys('manicpiano731') # See str 74, 78 Old password: manicpiano731, New password: new_valid_password_1
...
# 10. Enter the old password in the field "New Password" manicpiano731
wait.until(EC.presence_of_element_located(NW_VLD_PSWD)).clear()
wait.until(EC.presence_of_element_located(NW_VLD_PSWD)).send_keys('manicpiano731') # See str 41 Old password: manicpiano731, New password: new_valid_password_1
...
wait.until(EC.visibility_of_element_located(CNFRM_NW_VLD_PSWD)).send_keys('manicpiano731')
