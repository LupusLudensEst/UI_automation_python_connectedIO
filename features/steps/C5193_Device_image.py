...
@step("Device image should be present with the correct layout at the top left corner of page {dvc_rgth_lctn}")
def dvc_rgth_lctn(context, dvc_rgth_lctn):
    """
    Device image should be present with the correct layout at the top left corner of page {'x': 299, 'y': 253}
    """
    context.app.main_page.dvc_rgth_lctn(dvc_rgth_lctn)
